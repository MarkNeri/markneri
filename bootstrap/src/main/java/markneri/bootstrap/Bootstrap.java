...
public class Bootstrap {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException, NoSuchMethodException, InvocationTargetException, IllegalAccessException, NoSuchFieldException {
        ...
        for (int i = 0; i < numJars; i++) {
            ...
            if (name != null) {
                ...
                while (o < length) {
                    ...
                    if (numRead <= 0) throw new RuntimeException();
